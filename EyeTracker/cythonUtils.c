...
static __Pyx_memviewslice __pyx_f_11cythonUtils_calcGradientX(__Pyx_memviewslice, int, int, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static __Pyx_memviewslice __pyx_f_11cythonUtils_testPossibleCenterFormula(int, int, __Pyx_memviewslice, double, double, __Pyx_memviewslice, int, int, int __pyx_skip_dispatch); /*proto*/
static __Pyx_memviewslice __pyx_f_11cythonUtils_findEyeCenter(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int, int, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
static const char __pyx_k_magn[] = "magn";
...
static const char __pyx_k_inv_eye[] = "inv_eye";
...
static PyObject *__pyx_n_s_inv_eye;
static PyObject *__pyx_n_s_itemsize;
static PyObject *__pyx_kp_s_itemsize_0_for_cython_array;
static PyObject *__pyx_n_s_magn;
...
static PyObject *__pyx_pf_11cythonUtils_calcGradientX(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_frame, int __pyx_v_frameHeight, int __pyx_v_frameWidth, __Pyx_memviewslice __pyx_v_out); /* proto */
static PyObject *__pyx_pf_11cythonUtils_2testPossibleCenterFormula(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_x, int __pyx_v_y, __Pyx_memviewslice __pyx_v_inv_eye, double __pyx_v_gX, double __pyx_v_gY, __Pyx_memviewslice __pyx_v_out, int __pyx_v_h, int __pyx_v_w); /* proto */
static PyObject *__pyx_pf_11cythonUtils_4findEyeCenter(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_inv_eye, __Pyx_memviewslice __pyx_v_gx, __Pyx_memviewslice __pyx_v_gy, __Pyx_memviewslice __pyx_v_magn, int __pyx_v_frameHeight, int __pyx_v_frameWidth, __Pyx_memviewslice __pyx_v_out); /* proto */
...
static PyObject *__pyx_pw_11cythonUtils_1calcGradientX(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static __Pyx_memviewslice __pyx_f_11cythonUtils_calcGradientX(__Pyx_memviewslice __pyx_v_frame, int __pyx_v_frameHeight, int __pyx_v_frameWidth, __Pyx_memviewslice __pyx_v_out, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_h;
  ...
  __Pyx_RefNannySetupContext("calcGradientX", 0);
 ...
 */
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_frameWidth); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 5, __pyx_L1_error)
 ...
 */
    ...
    __pyx_t_7 = -1;
    if (__pyx_t_5 < 0) {
      __pyx_t_5 += __pyx_v_frame.shape[0];
      if (unlikely(__pyx_t_5 < 0)) __pyx_t_7 = 0;
    } else if (unlikely(__pyx_t_5 >= __pyx_v_frame.shape[0])) __pyx_t_7 = 0;
    if (__pyx_t_6 < 0) {
      __pyx_t_6 += __pyx_v_frame.shape[1];
      if (unlikely(__pyx_t_6 < 0)) __pyx_t_7 = 1;
    } else if (unlikely(__pyx_t_6 >= __pyx_v_frame.shape[1])) __pyx_t_7 = 1;
    ...
    __pyx_t_7 = -1;
    if (__pyx_t_8 < 0) {
      __pyx_t_8 += __pyx_v_frame.shape[0];
      if (unlikely(__pyx_t_8 < 0)) __pyx_t_7 = 0;
    } else if (unlikely(__pyx_t_8 >= __pyx_v_frame.shape[0])) __pyx_t_7 = 0;
    if (__pyx_t_9 < 0) {
      __pyx_t_9 += __pyx_v_frame.shape[1];
      if (unlikely(__pyx_t_9 < 0)) __pyx_t_7 = 1;
    } else if (unlikely(__pyx_t_9 >= __pyx_v_frame.shape[1])) __pyx_t_7 = 1;
    if (unlikely(__pyx_t_7 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_7);
      __PYX_ERR(0, 7, __pyx_L1_error)
    }
    ...
    __pyx_t_7 = -1;
    if (__pyx_t_10 < 0) {
      __pyx_t_10 += __pyx_v_out.shape[0];
      if (unlikely(__pyx_t_10 < 0)) __pyx_t_7 = 0;
    } else if (unlikely(__pyx_t_10 >= __pyx_v_out.shape[0])) __pyx_t_7 = 0;
    if (__pyx_t_11 < 0) {
      __pyx_t_11 += __pyx_v_out.shape[1];
      if (unlikely(__pyx_t_11 < 0)) __pyx_t_7 = 1;
    } else if (unlikely(__pyx_t_11 >= __pyx_v_out.shape[1])) __pyx_t_7 = 1;
    if (unlikely(__pyx_t_7 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_7);
      __PYX_ERR(0, 7, __pyx_L1_error)
    }
    *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_out.data + __pyx_t_10 * __pyx_v_out.strides[0]) ) + __pyx_t_11 * __pyx_v_out.strides[1]) )) = ((*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_frame.data + __pyx_t_5 * __pyx_v_frame.strides[0]) ) + __pyx_t_6 * __pyx_v_frame.strides[1]) ))) - (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_frame.data + __pyx_t_8 * __pyx_v_frame.strides[0]) ) + __pyx_t_9 * __pyx_v_frame.strides[1]) ))));
 ...
 */
    __pyx_t_1 = __Pyx_PyInt_SubtractObjC(__pyx_v_w, __pyx_int_1, 1, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 8, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_12 = PyTuple_New(2); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 8, __pyx_L1_error)
    ...
    __pyx_t_1 = 0;
    __pyx_t_1 = __Pyx_PyObject_Call(__pyx_builtin_range, __pyx_t_12, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 8, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    ...
    if (likely(PyList_CheckExact(__pyx_t_1)) || PyTuple_CheckExact(__pyx_t_1)) {
      ...
      __pyx_t_13 = -1; __pyx_t_12 = PyObject_GetIter(__pyx_t_1); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 8, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_12);
      __pyx_t_14 = Py_TYPE(__pyx_t_12)->tp_iternext; if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 8, __pyx_L1_error)
    }
    ...
    for (;;) {
      if (likely(!__pyx_t_14)) {
        if (likely(PyList_CheckExact(__pyx_t_12))) {
          ...
          __pyx_t_1 = PyList_GET_ITEM(__pyx_t_12, __pyx_t_13); __Pyx_INCREF(__pyx_t_1); __pyx_t_13++; if (unlikely(0 < 0)) __PYX_ERR(0, 8, __pyx_L1_error)
          #else
          __pyx_t_1 = PySequence_ITEM(__pyx_t_12, __pyx_t_13); __pyx_t_13++; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 8, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_1);
          #endif
        } else {
          if (__pyx_t_13 >= PyTuple_GET_SIZE(__pyx_t_12)) break;
          #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
          __pyx_t_1 = PyTuple_GET_ITEM(__pyx_t_12, __pyx_t_13); __Pyx_INCREF(__pyx_t_1); __pyx_t_13++; if (unlikely(0 < 0)) __PYX_ERR(0, 8, __pyx_L1_error)
          #else
          __pyx_t_1 = PySequence_ITEM(__pyx_t_12, __pyx_t_13); __pyx_t_13++; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 8, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_1);
          #endif
 ...
 *     return out;
 */
      __pyx_t_1 = __Pyx_PyInt_AddObjC(__pyx_v_x, __pyx_int_1, 1, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 9, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __pyx_t_15 = __Pyx_PyIndex_AsSsize_t(__pyx_t_1); if (unlikely((__pyx_t_15 == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 9, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __pyx_t_16 = __pyx_v_y;
      __pyx_t_17 = __pyx_t_15;
      __pyx_t_7 = -1;
      if (__pyx_t_16 < 0) {
        __pyx_t_16 += __pyx_v_frame.shape[0];
        if (unlikely(__pyx_t_16 < 0)) __pyx_t_7 = 0;
      } else if (unlikely(__pyx_t_16 >= __pyx_v_frame.shape[0])) __pyx_t_7 = 0;
      if (__pyx_t_17 < 0) {
        __pyx_t_17 += __pyx_v_frame.shape[1];
        if (unlikely(__pyx_t_17 < 0)) __pyx_t_7 = 1;
      } else if (unlikely(__pyx_t_17 >= __pyx_v_frame.shape[1])) __pyx_t_7 = 1;
      if (unlikely(__pyx_t_7 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_7);
        __PYX_ERR(0, 9, __pyx_L1_error)
      }
      __pyx_t_1 = __Pyx_PyInt_SubtractObjC(__pyx_v_x, __pyx_int_1, 1, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 9, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __pyx_t_18 = __Pyx_PyIndex_AsSsize_t(__pyx_t_1); if (unlikely((__pyx_t_18 == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 9, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __pyx_t_19 = __pyx_v_y;
      __pyx_t_20 = __pyx_t_18;
      __pyx_t_7 = -1;
      if (__pyx_t_19 < 0) {
        __pyx_t_19 += __pyx_v_frame.shape[0];
        if (unlikely(__pyx_t_19 < 0)) __pyx_t_7 = 0;
      } else if (unlikely(__pyx_t_19 >= __pyx_v_frame.shape[0])) __pyx_t_7 = 0;
      if (__pyx_t_20 < 0) {
        __pyx_t_20 += __pyx_v_frame.shape[1];
        if (unlikely(__pyx_t_20 < 0)) __pyx_t_7 = 1;
      } else if (unlikely(__pyx_t_20 >= __pyx_v_frame.shape[1])) __pyx_t_7 = 1;
      if (unlikely(__pyx_t_7 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_7);
        __PYX_ERR(0, 9, __pyx_L1_error)
      }
      __pyx_t_21 = __Pyx_PyIndex_AsSsize_t(__pyx_v_x); if (unlikely((__pyx_t_21 == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 9, __pyx_L1_error)
      ...
      } else if (unlikely(__pyx_t_22 >= __pyx_v_out.shape[0])) __pyx_t_7 = 0;
      if (__pyx_t_23 < 0) {
        __pyx_t_23 += __pyx_v_out.shape[1];
        if (unlikely(__pyx_t_23 < 0)) __pyx_t_7 = 1;
      } else if (unlikely(__pyx_t_23 >= __pyx_v_out.shape[1])) __pyx_t_7 = 1;
      if (unlikely(__pyx_t_7 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_7);
        __PYX_ERR(0, 9, __pyx_L1_error)
      }
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_out.data + __pyx_t_22 * __pyx_v_out.strides[0]) ) + __pyx_t_23 * __pyx_v_out.strides[1]) )) = (((*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_frame.data + __pyx_t_16 * __pyx_v_frame.strides[0]) ) + __pyx_t_17 * __pyx_v_frame.strides[1]) ))) - (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_frame.data + __pyx_t_19 * __pyx_v_frame.strides[0]) ) + __pyx_t_20 * __pyx_v_frame.strides[1]) )))) / 2.0);
 ...
 * 
 */
    __pyx_t_12 = __Pyx_PyInt_SubtractObjC(__pyx_v_w, __pyx_int_1, 1, 0); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 10, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_12);
    __pyx_t_13 = __Pyx_PyIndex_AsSsize_t(__pyx_t_12); if (unlikely((__pyx_t_13 == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 10, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
    __pyx_t_24 = __pyx_v_y;
    __pyx_t_25 = __pyx_t_13;
    __pyx_t_7 = -1;
    if (__pyx_t_24 < 0) {
      __pyx_t_24 += __pyx_v_frame.shape[0];
      if (unlikely(__pyx_t_24 < 0)) __pyx_t_7 = 0;
    } else if (unlikely(__pyx_t_24 >= __pyx_v_frame.shape[0])) __pyx_t_7 = 0;
    if (__pyx_t_25 < 0) {
      __pyx_t_25 += __pyx_v_frame.shape[1];
      if (unlikely(__pyx_t_25 < 0)) __pyx_t_7 = 1;
    } else if (unlikely(__pyx_t_25 >= __pyx_v_frame.shape[1])) __pyx_t_7 = 1;
    if (unlikely(__pyx_t_7 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_7);
      __PYX_ERR(0, 10, __pyx_L1_error)
    }
    __pyx_t_12 = __Pyx_PyInt_SubtractObjC(__pyx_v_w, __pyx_int_2, 2, 0); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 10, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_12);
    __pyx_t_18 = __Pyx_PyIndex_AsSsize_t(__pyx_t_12); if (unlikely((__pyx_t_18 == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 10, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
    __pyx_t_26 = __pyx_v_y;
    __pyx_t_27 = __pyx_t_18;
    __pyx_t_7 = -1;
    if (__pyx_t_26 < 0) {
      __pyx_t_26 += __pyx_v_frame.shape[0];
      if (unlikely(__pyx_t_26 < 0)) __pyx_t_7 = 0;
    } else if (unlikely(__pyx_t_26 >= __pyx_v_frame.shape[0])) __pyx_t_7 = 0;
    if (__pyx_t_27 < 0) {
      __pyx_t_27 += __pyx_v_frame.shape[1];
      if (unlikely(__pyx_t_27 < 0)) __pyx_t_7 = 1;
    } else if (unlikely(__pyx_t_27 >= __pyx_v_frame.shape[1])) __pyx_t_7 = 1;
    if (unlikely(__pyx_t_7 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_7);
      __PYX_ERR(0, 10, __pyx_L1_error)
    }
    __pyx_t_12 = __Pyx_PyInt_SubtractObjC(__pyx_v_w, __pyx_int_1, 1, 0); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 10, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_12);
    __pyx_t_15 = __Pyx_PyIndex_AsSsize_t(__pyx_t_12); if (unlikely((__pyx_t_15 == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 10, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
    ...
    } else if (unlikely(__pyx_t_28 >= __pyx_v_out.shape[0])) __pyx_t_7 = 0;
    if (__pyx_t_29 < 0) {
      __pyx_t_29 += __pyx_v_out.shape[1];
      if (unlikely(__pyx_t_29 < 0)) __pyx_t_7 = 1;
    } else if (unlikely(__pyx_t_29 >= __pyx_v_out.shape[1])) __pyx_t_7 = 1;
    if (unlikely(__pyx_t_7 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_7);
      __PYX_ERR(0, 10, __pyx_L1_error)
    }
    *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_out.data + __pyx_t_28 * __pyx_v_out.strides[0]) ) + __pyx_t_29 * __pyx_v_out.strides[1]) )) = ((*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_frame.data + __pyx_t_24 * __pyx_v_frame.strides[0]) ) + __pyx_t_25 * __pyx_v_frame.strides[1]) ))) - (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_frame.data + __pyx_t_26 * __pyx_v_frame.strides[0]) ) + __pyx_t_27 * __pyx_v_frame.strides[1]) ))));
  }
 ...
 */
  ...
  __Pyx_AddTraceback("cythonUtils.calcGradientX", __pyx_clineno, __pyx_lineno, __pyx_filename);
...
/* Python wrapper */
static PyObject *__pyx_pw_11cythonUtils_1calcGradientX(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_11cythonUtils_1calcGradientX(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_frame = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_frameHeight;
  int __pyx_v_frameWidth;
  __Pyx_memviewslice __pyx_v_out = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("calcGradientX (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_frame,&__pyx_n_s_frameHeight,&__pyx_n_s_frameWidth,&__pyx_n_s_out,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_frameHeight)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calcGradientX", 1, 4, 4, 1); __PYX_ERR(0, 3, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_frameWidth)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calcGradientX", 1, 4, 4, 2); __PYX_ERR(0, 3, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_out)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calcGradientX", 1, 4, 4, 3); __PYX_ERR(0, 3, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "calcGradientX") < 0)) __PYX_ERR(0, 3, __pyx_L3_error)
      }
    ...
    __pyx_v_frame = __Pyx_PyObject_to_MemoryviewSlice_dsds_unsigned_char(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_frame.memview)) __PYX_ERR(0, 3, __pyx_L3_error)
    __pyx_v_frameHeight = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_frameHeight == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 3, __pyx_L3_error)
    __pyx_v_frameWidth = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_frameWidth == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 3, __pyx_L3_error)
    __pyx_v_out = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_out.memview)) __PYX_ERR(0, 3, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("calcGradientX", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 3, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("cythonUtils.calcGradientX", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_11cythonUtils_calcGradientX(__pyx_self, __pyx_v_frame, __pyx_v_frameHeight, __pyx_v_frameWidth, __pyx_v_out);
...
static PyObject *__pyx_pf_11cythonUtils_calcGradientX(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_frame, int __pyx_v_frameHeight, int __pyx_v_frameWidth, __Pyx_memviewslice __pyx_v_out) {
  ...
  if (unlikely(!__pyx_v_frame.memview)) { __Pyx_RaiseUnboundLocalError("frame"); __PYX_ERR(0, 3, __pyx_L1_error) }
  if (unlikely(!__pyx_v_out.memview)) { __Pyx_RaiseUnboundLocalError("out"); __PYX_ERR(0, 3, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_11cythonUtils_calcGradientX(__pyx_v_frame, __pyx_v_frameHeight, __pyx_v_frameWidth, __pyx_v_out, 0); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 3, __pyx_L1_error)
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_t_1, 2, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 3, __pyx_L1_error)
...
static PyObject *__pyx_pw_11cythonUtils_3testPossibleCenterFormula(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static __Pyx_memviewslice __pyx_f_11cythonUtils_testPossibleCenterFormula(int __pyx_v_x, int __pyx_v_y, __Pyx_memviewslice __pyx_v_inv_eye, double __pyx_v_gX, double __pyx_v_gY, __Pyx_memviewslice __pyx_v_out, int __pyx_v_h, int __pyx_v_w, CYTHON_UNUSED int __pyx_skip_dispatch) {
  double __pyx_v_dx;
  double __pyx_v_dy;
  double __pyx_v_magn;
 ...
 */
      ...
      __pyx_t_18 = -1;
      if (__pyx_t_16 < 0) {
        __pyx_t_16 += __pyx_v_inv_eye.shape[0];
        if (unlikely(__pyx_t_16 < 0)) __pyx_t_18 = 0;
      } else if (unlikely(__pyx_t_16 >= __pyx_v_inv_eye.shape[0])) __pyx_t_18 = 0;
      if (__pyx_t_17 < 0) {
        __pyx_t_17 += __pyx_v_inv_eye.shape[1];
      ...
      __pyx_t_18 = -1;
      if (__pyx_t_21 < 0) {
        __pyx_t_21 += __pyx_v_out.shape[0];
        if (unlikely(__pyx_t_21 < 0)) __pyx_t_18 = 0;
      } else if (unlikely(__pyx_t_21 >= __pyx_v_out.shape[0])) __pyx_t_18 = 0;
      if (__pyx_t_22 < 0) {
        __pyx_t_22 += __pyx_v_out.shape[1];
...
/* Python wrapper */
static PyObject *__pyx_pw_11cythonUtils_3testPossibleCenterFormula(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_11cythonUtils_3testPossibleCenterFormula(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_x;
  int __pyx_v_y;
  __Pyx_memviewslice __pyx_v_inv_eye = { 0, 0, { 0 }, { 0 }, { 0 } };
  double __pyx_v_gX;
  double __pyx_v_gY;
  __Pyx_memviewslice __pyx_v_out = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_h;
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("testPossibleCenterFormula (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_x,&__pyx_n_s_y,&__pyx_n_s_inv_eye,&__pyx_n_s_gX,&__pyx_n_s_gY,&__pyx_n_s_out,&__pyx_n_s_h,&__pyx_n_s_w,0};
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_11cythonUtils_2testPossibleCenterFormula(__pyx_self, __pyx_v_x, __pyx_v_y, __pyx_v_inv_eye, __pyx_v_gX, __pyx_v_gY, __pyx_v_out, __pyx_v_h, __pyx_v_w);
...
static PyObject *__pyx_pf_11cythonUtils_2testPossibleCenterFormula(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_x, int __pyx_v_y, __Pyx_memviewslice __pyx_v_inv_eye, double __pyx_v_gX, double __pyx_v_gY, __Pyx_memviewslice __pyx_v_out, int __pyx_v_h, int __pyx_v_w) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  __Pyx_memviewslice __pyx_t_1 = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_t_2 = NULL;
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_inv_eye, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_out, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
static PyObject *__pyx_pw_11cythonUtils_5findEyeCenter(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static __Pyx_memviewslice __pyx_f_11cythonUtils_findEyeCenter(__Pyx_memviewslice __pyx_v_inv_eye, __Pyx_memviewslice __pyx_v_gx, __Pyx_memviewslice __pyx_v_gy, CYTHON_UNUSED __Pyx_memviewslice __pyx_v_magn, int __pyx_v_frameHeight, int __pyx_v_frameWidth, __Pyx_memviewslice __pyx_v_out, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_h;
  int __pyx_v_w;
  long __pyx_v_y;
  long __pyx_v_x;
 ...
 */
      ...
      __pyx_t_9 = -1;
      if (__pyx_t_7 < 0) {
        __pyx_t_7 += __pyx_v_gx.shape[0];
        if (unlikely(__pyx_t_7 < 0)) __pyx_t_9 = 0;
      } else if (unlikely(__pyx_t_7 >= __pyx_v_gx.shape[0])) __pyx_t_9 = 0;
      if (__pyx_t_8 < 0) {
        __pyx_t_8 += __pyx_v_gx.shape[1];
 ...
 */
      ...
      __pyx_t_9 = -1;
      if (__pyx_t_11 < 0) {
        __pyx_t_11 += __pyx_v_gy.shape[0];
        if (unlikely(__pyx_t_11 < 0)) __pyx_t_9 = 0;
      } else if (unlikely(__pyx_t_11 >= __pyx_v_gy.shape[0])) __pyx_t_9 = 0;
      if (__pyx_t_12 < 0) {
        __pyx_t_12 += __pyx_v_gy.shape[1];
...
/* Python wrapper */
static PyObject *__pyx_pw_11cythonUtils_5findEyeCenter(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_11cythonUtils_5findEyeCenter(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_inv_eye = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_gx = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_gy = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_magn = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_frameHeight;
  int __pyx_v_frameWidth;
  __Pyx_memviewslice __pyx_v_out = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("findEyeCenter (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_inv_eye,&__pyx_n_s_gx,&__pyx_n_s_gy,&__pyx_n_s_magn,&__pyx_n_s_frameHeight,&__pyx_n_s_frameWidth,&__pyx_n_s_out,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_inv_eye)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_11cythonUtils_4findEyeCenter(__pyx_self, __pyx_v_inv_eye, __pyx_v_gx, __pyx_v_gy, __pyx_v_magn, __pyx_v_frameHeight, __pyx_v_frameWidth, __pyx_v_out);
...
static PyObject *__pyx_pf_11cythonUtils_4findEyeCenter(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_inv_eye, __Pyx_memviewslice __pyx_v_gx, __Pyx_memviewslice __pyx_v_gy, __Pyx_memviewslice __pyx_v_magn, int __pyx_v_frameHeight, int __pyx_v_frameWidth, __Pyx_memviewslice __pyx_v_out) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  __Pyx_memviewslice __pyx_t_1 = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_t_2 = NULL;
  ...
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_inv_eye, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_gx, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_gy, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_magn, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_out, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
static PyMethodDef __pyx_methods[] = {
  {"calcGradientX", (PyCFunction)__pyx_pw_11cythonUtils_1calcGradientX, METH_VARARGS|METH_KEYWORDS, 0},
  {"testPossibleCenterFormula", (PyCFunction)__pyx_pw_11cythonUtils_3testPossibleCenterFormula, METH_VARARGS|METH_KEYWORDS, 0},
  {"findEyeCenter", (PyCFunction)__pyx_pw_11cythonUtils_5findEyeCenter, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_cythonUtils(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_cythonUtils},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_inv_eye, __pyx_k_inv_eye, sizeof(__pyx_k_inv_eye), 0, 0, 1, 1},
  {&__pyx_n_s_itemsize, __pyx_k_itemsize, sizeof(__pyx_k_itemsize), 0, 0, 1, 1},
  {&__pyx_kp_s_itemsize_0_for_cython_array, __pyx_k_itemsize_0_for_cython_array, sizeof(__pyx_k_itemsize_0_for_cython_array), 0, 0, 1, 0},
  {&__pyx_n_s_magn, __pyx_k_magn, sizeof(__pyx_k_magn), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initcythonUtils(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initcythonUtils(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_cythonUtils(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_cythonUtils(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec_cythonUtils(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_cythonUtils(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("cythonUtils", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
